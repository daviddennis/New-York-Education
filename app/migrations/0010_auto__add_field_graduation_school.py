...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graduation.school'
        db.add_column('app_graduation', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.School'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graduation.school'
        db.delete_column('app_graduation', 'school_id')
