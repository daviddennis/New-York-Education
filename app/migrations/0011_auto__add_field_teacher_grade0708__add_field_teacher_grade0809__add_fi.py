...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Teacher.grade0708'
        db.add_column('app_teacher', 'grade0708',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Teacher.grade0809'
        db.add_column('app_teacher', 'grade0809',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Teacher.grade0910'
        db.add_column('app_teacher', 'grade0910',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Teacher.grade0708'
        db.delete_column('app_teacher', 'grade0708')

        # Deleting field 'Teacher.grade0809'
        db.delete_column('app_teacher', 'grade0809')

        # Deleting field 'Teacher.grade0910'
        db.delete_column('app_teacher', 'grade0910')
