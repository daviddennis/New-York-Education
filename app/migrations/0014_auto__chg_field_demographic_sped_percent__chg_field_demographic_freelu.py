...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demographic.sped_percent'
        db.alter_column('app_demographic', 'sped_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.freelunch_reduced_percent'
        db.alter_column('app_demographic', 'freelunch_reduced_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.white_percent'
        db.alter_column('app_demographic', 'white_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.male_percent'
        db.alter_column('app_demographic', 'male_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.ell_percent'
        db.alter_column('app_demographic', 'ell_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.black_percent'
        db.alter_column('app_demographic', 'black_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.hispanic_percent'
        db.alter_column('app_demographic', 'hispanic_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.female_percent'
        db.alter_column('app_demographic', 'female_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))

        # Changing field 'Demographic.asian_percent'
        db.alter_column('app_demographic', 'asian_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1))
        # Adding field 'Teacher.description'
        db.add_column('app_teacher', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Teacher.photo_url'
        db.add_column('app_teacher', 'photo_url',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)

        # Adding field 'Teacher.poverty'
        db.add_column('app_teacher', 'poverty',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)

        # Adding field 'Teacher.profile_url'
        db.add_column('app_teacher', 'profile_url',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Demographic.sped_percent'
        db.alter_column('app_demographic', 'sped_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.freelunch_reduced_percent'
        db.alter_column('app_demographic', 'freelunch_reduced_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.white_percent'
        db.alter_column('app_demographic', 'white_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.male_percent'
        db.alter_column('app_demographic', 'male_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.ell_percent'
        db.alter_column('app_demographic', 'ell_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.black_percent'
        db.alter_column('app_demographic', 'black_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.hispanic_percent'
        db.alter_column('app_demographic', 'hispanic_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.female_percent'
        db.alter_column('app_demographic', 'female_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Demographic.asian_percent'
        db.alter_column('app_demographic', 'asian_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))
        # Deleting field 'Teacher.description'
        db.delete_column('app_teacher', 'description')

        # Deleting field 'Teacher.photo_url'
        db.delete_column('app_teacher', 'photo_url')

        # Deleting field 'Teacher.poverty'
        db.delete_column('app_teacher', 'poverty')

        # Deleting field 'Teacher.profile_url'
        db.delete_column('app_teacher', 'profile_url')
