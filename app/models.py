...
class Final(models.Model):
    dbn = models.CharField(max_length=6)
    va_0910_eng = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0910_math = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0809_eng = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0809_math = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0708_eng = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0708_math = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0607_eng = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    va_0607_math = models.DecimalField(max_digits=7, decimal_places=2, blank=True, null=True)
    school_name = models.CharField(max_length=100)
    grade = models.CharField(max_length=100, blank=True, null=True)
    teacherid = models.CharField(max_length=15, blank=True, null=True)
    last_name = models.CharField(max_length=40)
    first_name = models.CharField(max_length=40)
    freelunch = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    ell = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    asian = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    black = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    hisp = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    white = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    male = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    female = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    overall_grade = models.CharField(max_length=1, blank=True, null=True)
    dropout = models.DecimalField(max_digits=7, decimal_places=1, blank=True, null=True)
    va_0910_math = models.IntegerField(blank=True, null=True)
    cohort_category = models.CharField(max_length=30)
    cohort_size = models.IntegerField(blank=True, null=True)
    grads_num = models.IntegerField(blank=True, null=True)
    grads_percent = models.CharField(max_length=30)
